...
public class CpEntityManagerIT {
    ...
    private static final OrganizationScope SYSTEM_ORG_SCOPE =
            new OrganizationScopeImpl( new SimpleId( UUID.fromString( SYSTEM_ORG_UUID ), SYSTEM_ORG_TYPE ) );

    private static final CollectionScope SYSTEM_APP_SCOPE = new CollectionScopeImpl( SYSTEM_ORG_SCOPE.getOrganization(),
            new SimpleId( UUID.fromString( SYSTEM_APP_UUID ), SYSTEM_APP_TYPE ), SYSTEM_APP_TYPE );
...
//
    ...
    public void testApplication() {
        ...
        CpEntityManager cpEntityManager = new CpEntityManager( SYSTEM_APP_SCOPE, ecm, eci );
